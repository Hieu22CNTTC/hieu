...
('user_admin_001', 'admin@flight.com', '$2b$10$iT4tKXXa5UZEkyU894XHseoeQqQBmeHGXRbILgYXVy..k0FEix1zq', 'Admin User', '0901234567', 'ADMIN', NOW(3), NOW(3)),
('user_manager_001', 'manager@flight.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Manager User', '0901234568', 'MANAGER', NOW(3), NOW(3)),
('user_sales_001', 'sales@flight.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Sales User', '0901234569', 'SALES', NOW(3), NOW(3)),
('user_customer_001', 'customer@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Nguyen Van A', '0909123456', 'USER', NOW(3), NOW(3)),
('user_customer_002', 'tran.b@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Trần Thị B', '0912345678', 'USER', NOW(3), NOW(3)),
('user_customer_003', 'le.c@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Lê Văn C', '0923456789', 'USER', NOW(3), NOW(3)),
('user_customer_004', 'pham.d@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Phạm Thị D', '0934567890', 'USER', NOW(3), NOW(3)),
('user_customer_005', 'hoang.e@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Hoàng Văn E', '0945678901', 'USER', NOW(3), NOW(3)),
('user_customer_006', 'nguyen.f@gmail.com', '$2b$10$Q4xN71zOmFm0Q1q129aJSeWeaPdD5Evf1v004o44KfdnS5c2kSOk6', 'Nguyễn Thị F', '0956789012', 'USER', NOW(3), NOW(3));
...
('route_han_sgn', 'airport_han_001', 'airport_sgn_001', 1160, 120, 1500000, NOW(3), NOW(3)),
('route_han_dad', 'airport_han_001', 'airport_dad_001', 620, 75, 900000, NOW(3), NOW(3)),
('route_han_cxr', 'airport_han_001', 'airport_cxr_001', 980, 105, 1200000, NOW(3), NOW(3)),
('route_han_pqc', 'airport_han_001', 'airport_pqc_001', 1420, 135, 1800000, NOW(3), NOW(3)),
('route_sgn_han', 'airport_sgn_001', 'airport_han_001', 1160, 120, 1500000, NOW(3), NOW(3)),
('route_sgn_dad', 'airport_sgn_001', 'airport_dad_001', 610, 75, 850000, NOW(3), NOW(3)),
('route_sgn_pqc', 'airport_sgn_001', 'airport_pqc_001', 300, 50, 700000, NOW(3), NOW(3)),
('route_sgn_cxr', 'airport_sgn_001', 'airport_cxr_001', 320, 55, 750000, NOW(3), NOW(3)),
('route_dad_han', 'airport_dad_001', 'airport_han_001', 620, 75, 900000, NOW(3), NOW(3)),
('route_dad_sgn', 'airport_dad_001', 'airport_sgn_001', 610, 75, 850000, NOW(3), NOW(3)),
('route_dad_pqc', 'airport_dad_001', 'airport_pqc_001', 820, 90, 1100000, NOW(3), NOW(3)),
('route_cxr_han', 'airport_cxr_001', 'airport_han_001', 980, 105, 1200000, NOW(3), NOW(3)),
('route_cxr_sgn', 'airport_cxr_001', 'airport_sgn_001', 320, 55, 750000, NOW(3), NOW(3)),
('route_pqc_han', 'airport_pqc_001', 'airport_han_001', 1420, 135, 1800000, NOW(3), NOW(3)),
('route_pqc_sgn', 'airport_pqc_001', 'airport_sgn_001', 300, 50, 700000, NOW(3), NOW(3));
...
('coupon_summer_001', 'SUMMER2026', 15, 300000, '2026-06-01 00:00:00', '2026-08-31 23:59:59', 1000, 0, NOW(3), NOW(3)),
('coupon_newyear_001', 'NEWYEAR2026', 20, 500000, '2026-01-01 00:00:00', '2026-02-28 23:59:59', 500, 0, NOW(3), NOW(3)),
('coupon_flash_001', 'FLASH50', 50, 1000000, '2026-01-08 00:00:00', '2026-01-15 23:59:59', 100, 0, NOW(3), NOW(3)),
('coupon_vip_001', 'VIP100K', 10, 100000, '2026-01-01 00:00:00', '2026-12-31 23:59:59', 2000, 0, NOW(3), NOW(3)),
('coupon_danang_001', 'DANANG30', 30, 400000, '2026-01-15 00:00:00', '2026-03-31 23:59:59', 300, 0, NOW(3), NOW(3)),
('coupon_phuquoc_001', 'PHUQUOC25', 25, 600000, '2026-02-01 00:00:00', '2026-04-30 23:59:59', 400, 0, NOW(3), NOW(3));
